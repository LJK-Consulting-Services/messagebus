...
@pytest.fixture
def fake_redis():
    # Real EVAL, not a Python mirror of it: the pinned dev env installs `lupa`, so
    # fakeredis runs the bus's actual Lua (#116). tests/test_fakeredis_lua.py is the
    # guard that the dependency is really there.
